...
NExcStates = 30 # Number of excited states S1, S2, S3, ...

for stepDIR in range(550): # Some big number... #range( len(dirs) ):

    try:
        os.chdir(f"{stepDIR}")
    except:
        print (f"Skipping {stepDIR}/")
        continue
    print (f"Working on {stepDIR}")
