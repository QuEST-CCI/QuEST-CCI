...
def get_globals(THETA, PHI):
    ...
    ORIGIN = "SHIFTED" # "SHIFTED"

    ##### MAIN USER INPUT SECTION #####
    NM        = 15                  # Number of Electronic States (including ground state)
...
def get_ADIABATIC_DATA():
    ...
    EAD += np.loadtxt(f"../../QCHEM_{ORIGIN}/PLOTS_DATA/ADIABATIC_ENERGIES_RPA.dat")[:NM] # in AU
    MU  += np.load(f"../../QCHEM_{ORIGIN}/PLOTS_DATA/DIPOLE_RPA.dat.npy")[:NM,:NM] # in AU
