...
def get_ADIABATIC_DATA():
    ...
    if ( RPA == True ):
        EAD += np.loadtxt(f"../../../oBr/QCHEM/PLOTS_DATA/ADIABATIC_ENERGIES_RPA.dat")[:NM] # in AU
        MU  += np.load(f"../../../oBr/QCHEM/PLOTS_DATA/DIPOLE_RPA.dat.npy")[:NM,:NM] # in AU
    else:
        EAD += np.loadtxt(f"../../../oBr/QCHEM/PLOTS_DATA/ADIABATIC_ENERGIES_TDA.dat")[:NM] # in AU
        MU  += np.load(f"../../../oBr/QCHEM/PLOTS_DATA/DIPOLE_TDA.dat.npy")[:NM,:NM] # in AU
